 ...
 *
 * 支持平台：
 * - LM3S6965 (QEMU lm3s6965evb)
 * - STM32F103 (QEMU olimex-stm32-p103)
 */
...
/* ========== 平台特定配置 ========== */
    ...
    static const char *platform_name = "STM32F103";
    #define UART_DR_ADDR   0x40013804UL    /* USART1 DR寄存器地址 */
#elif defined(LM3S6965)
    /* LM3S6965 配置 */
    uint32_t SystemCoreClock = 50000000;   /* 50MHz */
    static const char *platform_name = "LM3S6965";
    #define UART_DR_ADDR   0x4000C000UL    /* UART0 DR寄存器地址 */
#else
    #error "未定义目标平台，请在编译时指定 -DSTM32F103 或 -DLM3S6965"
#endif
...
int main(void)
{
    ...
    uart_send_string("\r\n====================================\r\n");
    uart_send_string("  ");
    uart_send_string(platform_name);
    uart_send_string(" FreeRTOS 环境验证测试\r\n");
    uart_send_string("====================================\r\n\r\n");
